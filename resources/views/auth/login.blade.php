    ...
    <div class="max-w-[480px] w-full border border-slate-200 bg-slate-100 p-6">
        ...
        <div class="mt-5 mb-3">
            ...
            <input type="email" id="email"
                ...
                placeholder="e.g: Andi@Budi.com" required />
        </div>
        <div class="mb-5">
        ...
        <button class="block w-full bg-rose-500 text-white font-bold text-center py-1.5 mb-5 hover:bg-rose-400 transition-all">Login</button>
